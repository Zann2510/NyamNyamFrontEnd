...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { href: '/main/products', label: 'Produk', icon: Package },
    { href: '/main/orders', label: 'Pesanan', icon: ShoppingBag },
    { href: '/main/cart', label: 'Keranjang', icon: ShoppingCart, badge: getItemCount() },
    { href: '/main/profile', label: 'Akun', icon: User },
  ];

  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg flex justify-around items-center py-2 md:hidden z-40">
      {navItems.map((item) => {
